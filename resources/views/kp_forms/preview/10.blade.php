<x-kp-form-preview-layout>
    ...
    <div class="flex flex-col items-center">
        <p class="self-start text-justify">You are hereby required to appear before me on the ______________ day of ______________,
            ______________ at _______________ o’clock in the morning/afternoon for
    ...
    <div>
        <p>Notified this ________ day of __________, _________.</p>
    </div>
