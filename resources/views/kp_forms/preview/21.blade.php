<x-kp-form-preview-layout>
    ...
    <div class="flex flex-col">
        ...
        <ol class="list-decimal list-inside">
            ...
            <li>
                ...
                confrontation before the Pangkat likewise did not result into a settlement; and
            </li>
    ...
    <div class="flex flex-col w-1/4">
        <p class="self-start">This ______________ day of _______________, ____________.</p>
    </div>
