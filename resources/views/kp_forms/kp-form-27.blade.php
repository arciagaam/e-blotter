<x-kp-form-layout>
    ...
    <div class="flex flex-col">
        ...
        <p>
            WHEREAS, the party obliged ________________ (name) has not
            ...
            goods and personal property of __________________ (name of party
    ...
    <div class="break-inside-avoid">
        <p class="self-start">Signed this <span class="underline">{{date('jS', strtotime($issuedForm->created_at ?? now()))}}</span> day of <span class="underline">{{date('F', strtotime($issuedForm->created_at ?? now()))}}</span>, <span class="underline">{{date('Y', strtotime($issuedForm->created_at ?? now()))}}</span>.</p>
