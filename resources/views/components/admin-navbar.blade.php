<nav class="absolute top-0 left-0 max-w-[4rem]  z-50 flex flex-col min-h-screen h-screen bg-project-blue-dark text-white transition-all duration-500 ease-in-out drop-shadow-lg pb-10 pt-5 gap-12 pr-5">
        ...
        <div id="links-container" class="flex flex-col gap-10 whitespace-nowrap h-full overflow-hidden">
            ...
            <div class="flex flex-col gap-5 h-full">
                <a href="{{url('/admin/dashboard')}}" class="pl-5 flex items-center gap-5 transition-all duration-300 {{ request()->is('admin/dashboard*') ? 'text-project-yellow-default' : 'hover:text-project-yellow-default' }}">
                ...
                <a href="{{url('/admin/records')}}" class="pl-5 flex items-center gap-5 transition-all duration-300 {{ request()->is('admin/records*') ? 'text-project-yellow-default' : 'hover:text-project-yellow-default' }}">
                ...
                <a href="{{url('/admin/kp-forms')}}" class="pl-5 flex items-center gap-5 transition-all duration-300 {{ request()->is('admin/kp-forms*') ? 'text-project-yellow-default' : 'hover:text-project-yellow-default' }}">
                ...
                <a href="{{url('/admin/accounts')}}" class="pl-5 flex items-center gap-5 transition-all duration-300 {{ request()->is('admin/accounts*') ? 'text-project-yellow-default' : 'hover:text-project-yellow-default' }}">
