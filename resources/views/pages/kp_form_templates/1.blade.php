...
<div class="flex flex-col gap-5">
    ...
    <div class="form-input-container">
        ...
        <input class="form-input" type="date" name="hearing" id="hearing" value="{{ session()->has('editing_kp_form') ? date('Y-m-d', strtotime($issuedKpForm->issuedKpFormFields->where('tag_id', 'hearing')->value('value'))) : '' }}">
