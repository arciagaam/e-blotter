<x-kp-form-submit>
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="form-input-container">
            ...
            <input class="form-input" type="text" name="incapacity_to_discharge" id="incapacity_to_discharge" >
        ...
        <div class="form-input-container">
            ...
            <input class="form-input" type="text" name="unsuitability" id="unsuitability" >
            @error('unsuitability')
                <p class="text-xs text-red-500 italic">{{ $message }}</p>
            @enderror
        </div>
