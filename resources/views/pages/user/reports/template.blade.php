...
<body>
    <div id="main" class="flex flex-col gap-8 h-full">
        ...
        <div class="self-end break-inside-avoid mt-auto">
            <p>Report Generated by: <span class="underline underline-offset-4">{{ auth()->user()->first_name . " " . auth()->user()->last_name }}</span></p>
        </div>
    </div>
</body>
