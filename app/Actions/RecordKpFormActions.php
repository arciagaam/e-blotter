...
class RecordKpFormActions
{
    ...
    public function getMessageAndRecommendations($latestKpForm, string $record, GetKpFormMessageActions $action)
    {
        ...
        switch ($latestKpForm->kp_form_id) {
            ...
            case 15 : return $action->getKpForm15Message($record); break;
            ...
            case 21 : return $action->getKpForm21Message($record, $this); break;
            case 22 : return $action->getKpForm22Message($record, $this); break;
